...
export async function saveTweet(db, data) {
  ...
  await db.prepare(`
    INSERT INTO tweets (
      ...
      paid_price, public_price, whitelist_price, free_scope, is_free_whitelist,
  ...
  `).bind(
    ...
    data.paid_price || null, data.public_price || null, data.whitelist_price || null, data.free_scope || 'none', data.is_free_whitelist || 0,
